//Omarsito
package cuentaoptimizado;
import java.util.Scanner;
import javax.swing.JOptionPane;
public class CuentaOptimizado {
    private long numero;
    ...
    public void Datos(){
        ...
        System.out.println("Nombre del nuevo cliente: "); titular = num.next();
        System.out.println("Numerode la cuenta: "); numero = num.nextLong();
        System.out.println("El iteres anual: "); interesAnual = num.nextFloat();}
    public void Datos2(){
        System.out.println("Ingrese ls datos del nuevo cliente: ");
        System.out.println("Nombre del nuevo cliente: "); titular = un.next();
        System.out.println("Numero de la cuenta: "); numero = un.nextLong();
        System.out.println("El interes anual: "); interesAnual = un.nextFloat();}
    public void Menu(){
    ...
    public CuentaOptimizado(long aNumero, String aTitular, float aInteresAnual){
        numero = aNumero; 
        titular = aTitular;
        saldo = 0;
    ...
    public static void main(String[]args){
        ...
        CuentaOptimizado ob = new CuentaOptimizado(numeroC, titular, interesAnual);
        ob.Datos();
        int ingresar = 1;
        do{
            ob.Menu();
